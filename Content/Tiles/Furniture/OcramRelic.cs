...
namespace VanillaModding.Content.Tiles.Furniture
{
    ...
    public class OcramRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "VanillaModding/Content/Tiles/Furniture/OcramRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "VanillaModding/Content/Tiles/Furniture/RelicPedestal";
