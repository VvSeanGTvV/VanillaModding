...
namespace VanillaModding.Content.Items.Ammo
{
    internal class LifeStealBullet : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 7; // The damage for projectiles isn't actually 8, it actually is the damage combined with the projectile and the item together
        ...
        {
            //TODO: idk a something other than this goofy ah fright
            CreateRecipe(60)
